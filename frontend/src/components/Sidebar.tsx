    ...
    <aside className="w-60 flex-shrink-0 flex flex-col col-sidebar glass-strong border-r border-pi-border min-h-0 relative z-10">
      ...
      <AL.Root open={!!confirming} onOpenChange={o => !o && setConfirming(null)}>
        <AL.Portal>
          ...
          <AL.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 panel p-4 w-72 z-[101] anim-enter" style={{ animationDuration: '.18s' }}>
      ...
      <D.Root open={!!renaming} onOpenChange={o => !o && setRenaming(null)}>
        <D.Portal>
          ...
          <D.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 panel p-4 w-72 z-[101] anim-enter" style={{ animationDuration: '.18s' }}>
