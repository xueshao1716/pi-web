...
> **强制规则**：以下需求必须读取完整系统文档后生成：① 锦程酒店等完整视觉体系案例 ② 各物料模板库（名片/包装/网页）③ 用户指定参考某章某模板 ④ 本摘要参数与需求冲突时。完整文档在技能目录内，直接 read 即可。

- 完整 18 章系统：技能目录 `skills/wanxiang-design/万像平面-完整系统.docx`（8.2 万字，含全部模板库/案例/协议栈）
