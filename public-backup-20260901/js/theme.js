...
const THEMES = {
  ...
  neu:     { label:"拟态",   vars: makeVars("#6b7fd7","#8a9bf0","#5567c4","#fdfdfe","#f2f4f8","#fbfbfd","#f2f4f8","#e2e6ed","#3d4756","#7a8494","#a5aebe", 0) },
  ...
  apple:   { label:"苹果风", vars: makeVars("#0071e3","#5aa7f0","#0055b3","#ffffff","#f8f8fa","#ffffff","#f6f6f8","#e5e5e9","#1d1d1f","#6e6e73","#86868b", 0.15) },
