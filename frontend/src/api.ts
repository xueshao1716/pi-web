...
export const StoryApi = {
  ...
  run: (id: string, body: { sceneId: string; beatId: string; kind: StoryGenerationRun['kind']; model?: StoryGenerationRun['model']; params?: Record<string, unknown>; seed?: number; variants?: number; negative?: string; inputAssets?: StoryGenerationRun['inputAssets'] }) => api<{ project: StoryProject; run: StoryGenerationRun; runs?: StoryGenerationRun[]; context: { prompt: string; referenceIds: string[] }; plan?: StoryPlanStep[] }>(`/api/story/projects/${encodeURIComponent(id)}/run`, { method: 'POST', body, timeoutMs: 900000 }),
