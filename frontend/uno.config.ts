...
export default defineConfig({
  ...
  shortcuts: {
    'btn': 'inline-flex items-center justify-center gap-1.5 rounded-pi-md px-3 py-1.5 text-sm font-medium cursor-pointer transition-all duration-150 select-none disabled:opacity-50',
    ...
    'btn-tool': 'btn w-7 h-7 p-0 text-pi-dim hover:text-pi-text hover:bg-pi-bg3 rounded-pi-sm',
